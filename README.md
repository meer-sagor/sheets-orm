...
TypeORM-এর মতো একটি সম্পূর্ণ ফিচার্ড ORM যা Google Sheets-কে ডাটাবেস হিসেবে ব্যবহার করে। এতে রয়েছে ক্যাশিং, অ্যাডভান্সড কোয়েরি বিল্ডার এবং টাইপ সেফটি।
...
if (userSchema) {
  orm.registerEntity(User, userSchema);
}
